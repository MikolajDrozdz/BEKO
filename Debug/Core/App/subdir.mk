...
clean-Core-2f-App:
	-$(RM) ./Core/App/app.cyclo ./Core/App/app.d ./Core/App/app.o ./Core/App/app.su ./Core/App/bmp280_main.cyclo ./Core/App/bmp280_main.d ./Core/App/bmp280_main.o ./Core/App/bmp280_main.su ./Core/App/lcd_main.cyclo ./Core/App/lcd_main.d ./Core/App/lcd_main.o ./Core/App/lcd_main.su ./Core/App/led_array_main.cyclo ./Core/App/led_array_main.d ./Core/App/led_array_main.o ./Core/App/led_array_main.su ./Core/App/radio_main.cyclo ./Core/App/radio_main.d ./Core/App/radio_main.o ./Core/App/radio_main.su ./Core/App/tof_main.cyclo ./Core/App/tof_main.d ./Core/App/tof_main.o ./Core/App/tof_main.su
