...
/** @brief Internal helper: `radio_get_shaping_bits`. */
...
/** @brief Internal helper: `radio_get_frequency_deviation`. */
...
/** @brief Internal helper: `radio_get_packet_config_1`. */
...
/** @brief Internal helper: `radio_apply_fsk_config`. */
